...
sfr unsigned int          PMD2             absolute 0x0772;
    ...
    const register unsigned short int INDOUT = 3;
    sbit  INDOUT_bit at DFLTCON.B3;
    const register unsigned short int INDCK2 = 2;
    sbit  INDCK2_bit at DFLTCON.B2;
    const register unsigned short int INDCK1 = 1;
    sbit  INDCK1_bit at DFLTCON.B1;
    const register unsigned short int INDCK0 = 0;
    sbit  INDCK0_bit at DFLTCON.B0;
    ...
    const register unsigned short int LVDL3 = 11;
    sbit  LVDL3_bit at RCON.B11;
    const register unsigned short int LVDL2 = 10;
    sbit  LVDL2_bit at RCON.B10;
    const register unsigned short int LVDL1 = 9;
    sbit  LVDL1_bit at RCON.B9;
    const register unsigned short int LVDL0 = 8;
    sbit  LVDL0_bit at RCON.B8;
