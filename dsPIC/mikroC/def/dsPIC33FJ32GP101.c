// Definition file for P33FJ32GP101
...
sfr unsigned int volatile PMD4             absolute 0x0776;
    ...
    const register unsigned short int UTXISELO = 13;
    sbit  UTXISELO_bit at U1STA.B13;
    ...
    // AD1CHS0 bits
    const register unsigned short int CHONB = 15;
    sbit  CHONB_bit at AD1CHS0.B15;
...
// backward compatibility for I2C1RCVBITS
    typedef struct tagI2C1RCVBITS {
      unsigned I2C1RCV:8;
} typeI2C1RCVBITS;
sfr volatile typeI2C1RCVBITS I2C1RCVbits absolute 0x200;

// backward compatibility for I2C1TRNBITS
    typedef struct tagI2C1TRNBITS {
      unsigned I2C1TRN:8;
} typeI2C1TRNBITS;
sfr volatile typeI2C1TRNBITS I2C1TRNbits absolute 0x202;

// backward compatibility for I2C1BRGBITS
    typedef struct tagI2C1BRGBITS {
      unsigned I2C1BRG:9;
} typeI2C1BRGBITS;
sfr volatile typeI2C1BRGBITS I2C1BRGbits absolute 0x204;
