// Definition file for P33FJ06GS001
...
const unsigned long __FLASH_SIZE = 0x000017E8;
...
const unsigned IVT_ADDR_INTERRUPT2           = 0x0018;
...
const unsigned IVT_ADDR_INTERRUPT11          = 0x002A;
const unsigned IVT_ADDR_INTERRUPT12          = 0x002C;
...
const unsigned IVT_ADDR_INTERRUPT65          = 0x0096;
...
const unsigned AIVT_ADDR_ALTINTERRUPT2        = 0x0118;
...
const unsigned AIVT_ADDR_ALTINTERRUPT11       = 0x012A;
const unsigned AIVT_ADDR_ALTINTERRUPT12       = 0x012C;
...
const unsigned AIVT_ADDR_ALTINTERRUPT65       = 0x0196;
...
sfr unsigned int volatile PMD7             absolute 0x077C;
    ...
    // PMD7 bits
    const register unsigned short int CMPMD2 = 9;
    sbit  CMPMD2_bit at PMD7.B9;
    const register unsigned short int CMPMD1 = 8;
    sbit  CMPMD1_bit at PMD7.B8;
