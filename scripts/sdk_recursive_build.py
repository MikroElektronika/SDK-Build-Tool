...
def run_builds(changes_dict):
    ...
    cmd = f'xvfb-run --auto-servernum --server-num=1 {toolPath} --isBareMetal "0" --compiler "{compilers[0][0]}" --sdk "{sdk_version}" --mcu "MCU_CARD_FOR_KINETIS_MK64FN1M0VDC12" --installPrefix "{testPath}/mcu_card_build/"'
...
def main():
    ...
    if os.getenv('BUILD_CHANGED_FILES') == '1':
