...
const unsigned int IVT_ADDR_UART_RX          = 0x0016;
const unsigned int IVT_ADDR_UART_UDRE        = 0x0018;
const unsigned int IVT_ADDR_UART_TX          = 0x001A;
...
sfr io unsigned short volatile SPMCR absolute 0x57;
    ...
    sbit  ASRE_bit at SPMCR.B4;
    const register unsigned short int ASRE = 4;
    sbit  ASB_bit at SPMCR.B6;
    const register unsigned short int ASB = 6;
