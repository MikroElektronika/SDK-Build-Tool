...
const unsigned int IVT_ADDR_SPI_STC          = 0x000A;
const unsigned int IVT_ADDR_USART_RX         = 0x000B;
const unsigned int IVT_ADDR_USART_UDRE       = 0x000C;
const unsigned int IVT_ADDR_USART_TX         = 0x000D;
...
const unsigned int IVT_ADDR_TIMER0_COMP      = 0x0013;
const unsigned int IVT_ADDR_SPM_RDY          = 0x0014;
...
sfr io unsigned short volatile UCSRC absolute 0x40;
    ...
    sbit  URSEL_UCSRC_bit at UCSRC.B7;
