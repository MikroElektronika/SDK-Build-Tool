...
const unsigned int IVT_ADDR_TIMER1_COMP      = 0x0004;
const unsigned int IVT_ADDR_TIMER1_OVF       = 0x0005;
const unsigned int IVT_ADDR_TIMER0_OVF       = 0x0006;
const unsigned int IVT_ADDR_SPI_STC          = 0x0007;
const unsigned int IVT_ADDR_UART_RX          = 0x0008;
const unsigned int IVT_ADDR_UART_UDRE        = 0x0009;
const unsigned int IVT_ADDR_UART__TX         = 0x000A;
const unsigned int IVT_ADDR_ADC              = 0x000B;
const unsigned int IVT_ADDR_EE_RDY           = 0x000C;
const unsigned int IVT_ADDR_ANA_COMP         = 0x000D;
...
sfr io unsigned short TIMSK absolute 0x59;
    ...
    sbit  OCIE1_bit at TIMSK.B6;
    const register unsigned short int OCIE1 = 6;
...
sfr io unsigned short volatile TIFR absolute 0x58;
    ...
    sbit  OCF1_bit at TIFR.B6;
    const register unsigned short int OCF1 = 6;
...
sfr io unsigned short TCCR1A absolute 0x4F;
    ...
    sbit  COM10_bit at TCCR1A.B6;
    const register unsigned short int COM10 = 6;
    sbit  COM11_bit at TCCR1A.B7;
    const register unsigned short int COM11 = 7;
...
sfr io unsigned short ADMUX absolute 0x27;
    ...
    sbit  ADCBG_bit at ADMUX.B6;
    const register unsigned short int ADCBG = 6;
...
sfr io unsigned short UBRRHI absolute 0x23;
    sbit  UBRRHI0_bit at UBRRHI.B0;
    const register unsigned short int UBRRHI0 = 0;
    sbit  UBRRHI1_bit at UBRRHI.B1;
    const register unsigned short int UBRRHI1 = 1;
    sbit  UBRRHI2_bit at UBRRHI.B2;
    const register unsigned short int UBRRHI2 = 2;
    sbit  UBRRHI3_bit at UBRRHI.B3;
    const register unsigned short int UBRRHI3 = 3;
