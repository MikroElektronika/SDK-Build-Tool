...
const unsigned int IVT_ADDR_WDT              = 0x0004;
const unsigned int IVT_ADDR_TIM1_COMPA       = 0x0005;
const unsigned int IVT_ADDR_TIM1_COMPB       = 0x0006;
const unsigned int IVT_ADDR_TIM1_OVF         = 0x0007;
const unsigned int IVT_ADDR_TIM0_COMPA       = 0x0008;
const unsigned int IVT_ADDR_TIM0_COMPB       = 0x0009;
const unsigned int IVT_ADDR_TIM0_OVF         = 0x000A;
const unsigned int IVT_ADDR_ANA_COMP         = 0x000B;
const unsigned int IVT_ADDR_ADC              = 0x000C;
const unsigned int IVT_ADDR_EE_RDY           = 0x000D;
const unsigned int IVT_ADDR_USI_START        = 0x000E;
const unsigned int IVT_ADDR_USI_OVF          = 0x000F;
...
sfr io unsigned short TCCR1B absolute 0x4E;
    ...
    sbit  FOC1B_bit at TCCR1B.B6;
    const register unsigned short int FOC1B = 6;
    sbit  FOC1A_bit at TCCR1B.B7;
    const register unsigned short int FOC1A = 7;

sfr io unsigned short volatile TCNT1 absolute 0x4D;
...
sfr io unsigned short volatile OCR1A absolute 0x4C;
    sbit  OCR1_0_bit at OCR1A.B0;
    const register unsigned short int OCR1_0 = 0;
    sbit  OCR1_1_bit at OCR1A.B1;
    const register unsigned short int OCR1_1 = 1;
    sbit  OCR1_2_bit at OCR1A.B2;
    const register unsigned short int OCR1_2 = 2;
    sbit  OCR1_3_bit at OCR1A.B3;
    const register unsigned short int OCR1_3 = 3;
    sbit  OCR1_4_bit at OCR1A.B4;
    const register unsigned short int OCR1_4 = 4;
    sbit  OCR1_5_bit at OCR1A.B5;
    const register unsigned short int OCR1_5 = 5;
    sbit  OCR1_6_bit at OCR1A.B6;
    const register unsigned short int OCR1_6 = 6;
    sbit  OCR1_7_bit at OCR1A.B7;
    const register unsigned short int OCR1_7 = 7;

sfr io unsigned short volatile OCR1B absolute 0x4B;
    sbit  OCR1_0_OCR1B_bit at OCR1B.B0;
    sbit  OCR1_1_OCR1B_bit at OCR1B.B1;
    sbit  OCR1_2_OCR1B_bit at OCR1B.B2;
    sbit  OCR1_3_OCR1B_bit at OCR1B.B3;
    sbit  OCR1_4_OCR1B_bit at OCR1B.B4;
    sbit  OCR1_5_OCR1B_bit at OCR1B.B5;
    sbit  OCR1_6_OCR1B_bit at OCR1B.B6;
    sbit  OCR1_7_OCR1B_bit at OCR1B.B7;
...
sfr io unsigned short ADMUX absolute 0x27;
    ...
    sbit  REFS_bit at ADMUX.B6;
    const register unsigned short int REFS = 6;
...
sfr io unsigned short ADCSRB absolute 0x23;
    ...
    sbit  BVRON_bit at ADCSRB.B7;
    const register unsigned short int BVRON = 7;
...
sfr io unsigned short DIDR0 absolute 0x21;
    ...
    sbit  AIN0D_bit at DIDR0.B4;
    const register unsigned short int AIN0D = 4;
    sbit  AIN1D_bit at DIDR0.B5;
    const register unsigned short int AIN1D = 5;
