...
const unsigned int IVT_ADDR_USART_RX         = 0x0009;
const unsigned int IVT_ADDR_USART_UDRE       = 0x000A;
const unsigned int IVT_ADDR_USART__TX        = 0x000B;
const unsigned int IVT_ADDR_ANA_COMP         = 0x000C;
const unsigned int IVT_ADDR_INT2             = 0x000D;
const unsigned int IVT_ADDR_TIMER0_COMP      = 0x000E;
const unsigned int IVT_ADDR_EE_RDY           = 0x000F;
const unsigned int IVT_ADDR_SPM_RDY          = 0x0010;
