...
const unsigned int IVT_ADDR_BPINT            = 0x0001;
const unsigned int IVT_ADDR_VREGMON          = 0x0002;
const unsigned int IVT_ADDR_INT0             = 0x0003;
const unsigned int IVT_ADDR_INT1             = 0x0004;
const unsigned int IVT_ADDR_INT2             = 0x0005;
const unsigned int IVT_ADDR_WDT              = 0x0006;
const unsigned int IVT_ADDR_TIMER1_IC        = 0x0007;
const unsigned int IVT_ADDR_TIMER1_COMPA     = 0x0008;
const unsigned int IVT_ADDR_TIMER1_COMPB     = 0x0009;
const unsigned int IVT_ADDR_TIMER1_OVF       = 0x000A;
const unsigned int IVT_ADDR_TIMER0_IC        = 0x000B;
...
const unsigned int IVT_ADDR_VADC             = 0x0010;
const unsigned int IVT_ADDR_CCADC_CONV       = 0x0011;
const unsigned int IVT_ADDR_CCADC_REG_CUR    = 0x0012;
const unsigned int IVT_ADDR_CCADC_ACC        = 0x0013;
const unsigned int IVT_ADDR_EE_READY         = 0x0014;
