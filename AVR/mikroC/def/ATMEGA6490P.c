...
sfr data unsigned char volatile LCDDR9                    absolute 0x00F5;
sfr data unsigned char volatile LCDDR8                    absolute 0x00F4;
sfr data unsigned char volatile LCDDR7                    absolute 0x00F3;
sfr data unsigned char volatile LCDDR6                    absolute 0x00F2;
sfr data unsigned char volatile LCDDR5                    absolute 0x00F1;
sfr data unsigned char volatile LCDDR4                    absolute 0x00F0;
sfr data unsigned char volatile LCDDR3                    absolute 0x00EF;
sfr data unsigned char volatile LCDDR2                    absolute 0x00EE;
sfr data unsigned char volatile LCDDR1                    absolute 0x00ED;
sfr data unsigned char volatile LCDDR0                    absolute 0x00EC;
