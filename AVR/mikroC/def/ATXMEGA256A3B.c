...
sfr data unsigned short volatile RTC32_CTRL           absolute 0x0420;
sfr data unsigned short volatile RTC32_SYNCCTRL       absolute 0x0421;
sfr data unsigned short volatile RTC32_INTCTRL        absolute 0x0422;
sfr data unsigned short volatile RTC32_INTFLAGS       absolute 0x0423;
sfr data unsigned short volatile RTC32_CNT            absolute 0x0424;
sfr data unsigned short volatile RTC32_PER            absolute 0x0428;
sfr data unsigned short volatile RTC32_COMP           absolute 0x042C;
...
sfr data unsigned short volatile VBAT_CTRL            absolute 0x00F0;
sfr data unsigned short volatile VBAT_STATUS          absolute 0x00F1;
sfr data unsigned short volatile VBAT_BACKUP0         absolute 0x00F2;
sfr data unsigned short volatile VBAT_BACKUP1         absolute 0x00F3;
    ...
    // VBAT_CTRL bits
    sbit  XOSCPWR_bit at VBAT_CTRL.B5;
    const register unsigned short int XOSCPWR = 5;
    ...
    const register unsigned short int XOSCFDEN_VBAT_CTRL = 2;
    sbit  ACCEN_bit at VBAT_CTRL.B1;
    const register unsigned short int ACCEN = 1;
    sbit  RESET_VBAT_CTRL_bit at VBAT_CTRL.B0;
    const register unsigned short int RESET_VBAT_CTRL = 0;
