...
const unsigned short IVT_ADDR_PORTE_INT0 = 0x006C; // External Interrupt 0
const unsigned short IVT_ADDR_PORTE_INT1 = 0x006E; // External Interrupt 1

// TCE0 interrupt vectors
const unsigned short IVT_ADDR_TCE0_OVF = 0x0074; // Overflow Interrupt
const unsigned short IVT_ADDR_TCE0_ERR = 0x0076; // Error Interrupt
const unsigned short IVT_ADDR_TCE0_CCA = 0x0078; // Compare or Capture A Interrupt
const unsigned short IVT_ADDR_TCE0_CCB = 0x007A; // Compare or Capture B Interrupt
const unsigned short IVT_ADDR_TCE0_CCC = 0x007C; // Compare or Capture C Interrupt
const unsigned short IVT_ADDR_TCE0_CCD = 0x007E; // Compare or Capture D Interrupt

// TCE2 interrupt vectors
const unsigned short IVT_ADDR_TCE2_LUNF = 0x0074; // Low Byte Underflow Interrupt
const unsigned short IVT_ADDR_TCE2_HUNF = 0x0076; // High Byte Underflow Interrupt
const unsigned short IVT_ADDR_TCE2_LCMPA = 0x0078; // Low Byte Compare A Interrupt
const unsigned short IVT_ADDR_TCE2_LCMPB = 0x007A; // Low Byte Compare B Interrupt
const unsigned short IVT_ADDR_TCE2_LCMPC = 0x007C; // Low Byte Compare C Interrupt
const unsigned short IVT_ADDR_TCE2_LCMPD = 0x007E; // Low Byte Compare D Interrupt

// USARTE0 interrupt vectors
const unsigned short IVT_ADDR_USARTE0_RXC = 0x008A; // Reception Complete Interrupt
const unsigned short IVT_ADDR_USARTE0_DRE = 0x008C; // Data Register Empty Interrupt
const unsigned short IVT_ADDR_USARTE0_TXC = 0x008E; // Transmission Complete Interrupt

// PORTA interrupt vectors
const unsigned short IVT_ADDR_PORTA_INT0 = 0x0096; // External Interrupt 0
const unsigned short IVT_ADDR_PORTA_INT1 = 0x0098; // External Interrupt 1

// ACA interrupt vectors
const unsigned short IVT_ADDR_ACA_AC0 = 0x009A; // AC0 Interrupt
const unsigned short IVT_ADDR_ACA_AC1 = 0x009C; // AC1 Interrupt
const unsigned short IVT_ADDR_ACA_ACW = 0x009E; // ACW Window Mode Interrupt

// ADCA interrupt vectors
const unsigned short IVT_ADDR_ADCA_CH0 = 0x00A0; // Interrupt 0
...
sfr data unsigned char volatile ADCB_SAMPCTRL             absolute 0x0248;
    sbit  SAMPVAL0_ADCB_SAMPCTRL_bit at ADCB_SAMPCTRL.B0;
    sbit  SAMPVAL1_ADCB_SAMPCTRL_bit at ADCB_SAMPCTRL.B1;
    sbit  SAMPVAL2_ADCB_SAMPCTRL_bit at ADCB_SAMPCTRL.B2;
    sbit  SAMPVAL3_ADCB_SAMPCTRL_bit at ADCB_SAMPCTRL.B3;
    sbit  SAMPVAL4_ADCB_SAMPCTRL_bit at ADCB_SAMPCTRL.B4;
    sbit  SAMPVAL5_ADCB_SAMPCTRL_bit at ADCB_SAMPCTRL.B5;
...
sfr data unsigned char volatile ADCB_CH0_SCAN             absolute 0x0266;
    ...
    sbit  COUNT0_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B0;
    sbit  COUNT1_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B1;
    sbit  COUNT2_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B2;
    sbit  COUNT3_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B3;
...
sfr data unsigned char volatile ACB_CURRCTRL              absolute 0x0398;
    sbit  CURREN_ACB_CURRCTRL_bit at ACB_CURRCTRL.B7;
    sbit  CURRMODE_ACB_CURRCTRL_bit at ACB_CURRCTRL.B6;
    sbit  AC1CURR_ACB_CURRCTRL_bit at ACB_CURRCTRL.B1;
    sbit  AC0CURR_ACB_CURRCTRL_bit at ACB_CURRCTRL.B0;

sfr data unsigned char volatile ACB_CURRCALIB             absolute 0x0399;
    sbit  CALIB0_ACB_CURRCALIB_bit at ACB_CURRCALIB.B0;
    sbit  CALIB1_ACB_CURRCALIB_bit at ACB_CURRCALIB.B1;
    sbit  CALIB2_ACB_CURRCALIB_bit at ACB_CURRCALIB.B2;
    sbit  CALIB3_ACB_CURRCALIB_bit at ACB_CURRCALIB.B3;
